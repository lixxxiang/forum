...
* [x] 列表中应增加筛选功能，如基于类型和区域的条件查询，增加采集条数计数功能，以便在较大区域使用过程中对采集情况整体把握较好
* [x] 应具打开kml文件、图斑导航功能：野外信息采集会提前规划路线和点位，借鉴本部门其他APP离线/在线导航，指引信息采集或者核查人通过导航功能到达预先规划目的地
* [x] 提交之后，本地保存的可以重复提交
* [x] 使用聚类方式解决大量Markers导致的地图卡顿问题
* [x] 测量功能，包括多点位的距离测量，区域面积的测量功能
